<div>
    ...
    <form method="POST" action="{{ route('clients.store') }}">
        ...
        <div class="mb-4">
            ...
            <x-input id="company_email" class="block mt-1 w-full" type="email" name="company_email" :value="old('company_email')" required />
        </div>
        <div class="mb-4">
            <x-label for="client_type" :value="__('Client Type')" />
            <x-select name="client_type" :options="$types" :selected="old('client_type')" class="block mt-1 w-full" placeholder="Client Type" required />
        </div>
        <div class="mb-4" id="date_of_birth_div" style="display: none">
            <x-label for="date_of_birth" :value="__('Date of Birth')" />
            <x-input id="date_of_birth" class="block mt-1 w-full" type="date" name="date_of_birth" :value="old('date_of_birth')" />
        </div>
        <div class="mb-4" id="company_registration_number_div" style="display: none">
            <x-label for="company_registration_number" :value="__('Company Registration Number')" />
            <x-input id="company_registration_number" class="block mt-1 w-full" type="text" name="company_registration_number" :value="old('company_registration_number')" />
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <x-input id="contact_email" class="block mt-1 w-full" type="email" name="contact_email" :value="old('contact_email')" required />
        </div>
